    ...
    <div className="bg-gradient-to-br from-sky-500 to-indigo-500 text-white pt-16">
      <div className="container mx-auto flex flex-col md:flex-row items-center flex-wrap px-3">
        ...
        <div className="flex flex-col w-full justify-center items-start md:w-2/5 text-center md:text-left">
          ...
          <p className="capitalize leading-normal text-xl mb-8">
            Join a community that thrives learning, creating and growing
            together
          </p>
        </div>
        {/* Right col */}
        <div className="w-full flex justify-center text-center py-7 md:w-3/5 z-30">
          <img src="/hero.png" alt="Hero Image" className="w-full md:w-3/4" />
        </div>
      </div>
